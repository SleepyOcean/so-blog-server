...
INSERT INTO `so_project` VALUES ('2c9020f86c03fec7016c040499020001', '2019-07-18 15:38:25', '2019-07-20', '文章全局搜索接口', '实现文章全局搜索', 'SO博客后台', 0, NULL, 0);
...
INSERT INTO `so_project` VALUES ('2c9020f86c03fec7016c040643850003', '2019-07-18 15:40:15', '2019-07-20', '关于页面', '关于页面（包含SO博客系统介绍和自我介绍）', 'SO博客前台', 0, NULL, 0);
INSERT INTO `so_project` VALUES ('2c9020f86c07d3fa016c095669c40000', '2019-07-19 16:25:53', '2019-07-21', '后台管理-文章管理页面', '功能：搜索、查看、编辑、修改、删除', 'SO博客前台', 0, NULL, 0);
INSERT INTO `so_project` VALUES ('2c9020f86c07d3fa016c0958bc0b0001', '2019-07-19 16:28:25', '2019-07-21', '后台管理-文章编写/编辑页面', '功能：添加封面（默认取文章中的第一张图片）、添加摘要/副标题（默认从文章的<more>标签中获取）、添加主题/专栏、添加文章来源、文章可见', 'SO博客前台', 0, NULL, 0);
INSERT INTO `so_project` VALUES ('2c9020f86c07d3fa016c095b23a20002', '2019-07-19 16:31:03', '2019-07-21', '后台管理-仪表盘页面', '功能：专栏展示、TODO计划栏、恢复文章编写（文章历史纪录）、文章提交日统计（柱状）图、访问量统计（折线）图、标签展示（饼状）图、访问数、文章总数、转发数、评论数、关注数', 'SO博客前台', 0, NULL, 0);
